...
class SnackTests(TestCase):
    def setUp(self):
        ...
        self.snack = Snack.objects.create(
            name="pickle", review="so refreshing", purchaser=self.user,
        )
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(self.snack.review, "so refreshing")
    ...
    def test_snack_update_view_redirect(self):
        response = self.client.post(
            ...
            {"name": "Updated name", "review": "low on calories", "purchaser": self.user.id}
        )
